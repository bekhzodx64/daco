...
const Advantages = () => {
  ...
  return (
    <div className={`pt-20`} id="advantages">
      ...
      <div className="container">
        <div className="lg:pl-52">
          <h2 className="section-title">{t("Our advantages")}</h2>
          <p className="section-description">
            {t("Get to know the best aspects of our company")}
          </p>
        </div>
            ...
            <div key={advantage.id}>
              <div className="flex flex-col gap-7">
                ...
                <div className="flex flex-col gap-3">
                  <h2 className="text-2xl font-medium">{t(advantage.title)}</h2>
