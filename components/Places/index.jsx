...
const Places = () => {
  ...
  return (
    <div className={`${styles.places} container`} id="places">
      ...
      <h2 className="text-center section-title">{t("Our available places")}</h2>

      <div>
        <h2 className="text-center">{`1. ${t("Choose project")}`}</h2>
      ...
      <div className={styles["places-section"]}>
        <h2 className="text-center">{`2. ${t("Choose available places")}`}</h2>

        <div className={styles["places-plans"]}>
          {indexPlan?.map((item, index) => {
            console.log(item);
            return <Plans key={index} plan={item} />;
          })}
        </div>
      </div>
      ...
      <div>
        ...
        >
          <div className={styles["places-section"]}>
            <h2 className="mb-10">{`3. ${t("You choosed")}`}</h2>
          ...
          <div className={styles["places-section"]}>
            <h2 className="mb-10">{`4. ${t("Fill an application below")}`}</h2>
              ...
              <div className={styles["places-form"]}>
                ...
                <div className="flex justify-center mt-[15px]">
                  <button className={styles["places-form__button"]}>
                    <span>{t("Send all information")}</span>
